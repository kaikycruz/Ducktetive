...
function buscarUltimasMedidasCPU(req, res) {
    ...
    medidaModel.buscarUltimasMedidasCPU(idServidor).then(function (resultado) {
...
function buscarUltimasMedidasRAM(req, res) {
    ...
    medidaModel.buscarUltimasMedidasRAM(idServidor).then(function (resultado) {
        if (resultado.length > 0) {
            res.status(200).json(resultado);
        } else {
            res.status(204).send("Nenhum resultado encontrado!")
...
function buscarUltimasMedidasDISCO(req, res) {
    ...
    medidaModel.buscarUltimasMedidasDISCO(idServidor).then(function (resultado) {
        if (resultado.length > 0) {
            res.status(200).json(resultado);
        } else {
            res.status(204).send("Nenhum resultado encontrado!")
...
function buscarUltimasMedidasREDE(req, res) {
    ...
    medidaModel.buscarUltimasMedidasREDE(idServidor).then(function (resultado) {
        if (resultado.length > 0) {
            res.status(200).json(resultado);
        } else {
            res.status(204).send("Nenhum resultado encontrado!")
