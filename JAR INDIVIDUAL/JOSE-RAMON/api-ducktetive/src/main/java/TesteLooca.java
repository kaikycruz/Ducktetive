        ...
        do {
            ...
            switch (operacao) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    System.out.println("Insira nome do Servidor");
                    String servidor = leitortring.nextLine();
                    System.out.println("Insira nome do Componente");
                    String componente = leitortring.nextLine();
                    loocaDao.exibirInovação(componente, servidor);
                    break;
                case 6:
