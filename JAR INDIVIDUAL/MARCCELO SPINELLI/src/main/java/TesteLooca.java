...
public class TesteLooca {
        ...
        do {
            ...
            switch (operacao) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    System.out.println("Inovação - Gerar Relatório Especial");
                    gerarRelatorioEspecial(loocaDao);
                    break;
                case 6:
    ...
    private static void gerarRelatorioEspecial(LoocaDao loocaDao) {
        System.out.println("Gerando Relatório Especial...");


        List<Metrica> todasMetricas = loocaDao.obterTodasMetricas();
